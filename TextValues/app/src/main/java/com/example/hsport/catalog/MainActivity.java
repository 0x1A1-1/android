...
public class MainActivity extends AppCompatActivity {
    ...
    private CoordinatorLayout coordniatorLayout;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordniatorLayout = (CoordinatorLayout) findViewById(R.id.coordinator);
...
//            Toast.makeText(MainActivity.this, "You selected setting", Toast.LENGTH_LONG).show();
            Snackbar.make(coordniatorLayout, "You selected settings", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            return true;
        }
